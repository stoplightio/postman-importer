        ...
        "type": [
          ...
          "name": "items",
            ...
            "Category"
				...
				**/
				if (definition.items.hasOwnProperty('items') && _.isArray(definition.items.items) && definition.items.items.length === 1 && typeof definition.items.items[0] === 'string') {
          definition.items.items.type = definition.items.items[0];
        }
			}
			else {
