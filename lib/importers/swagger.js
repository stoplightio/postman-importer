...
Swagger.prototype._parseData = function(dataOrPath, options) {
	...
	return new Promise(function(resolve, reject) {
		...
		if (options && options.hasOwnProperty('validateInput') && (options.validateInput === true || options.validateOutput === true)) {
			customOptions = {
				schema: true,
				spec: true
			};
...
Swagger.prototype._mapEndpoints = function(consumes, produces) {
  for (var path in this.data.paths) {
    ...
    for (var method in methods) {
      ...
      //map path params
			var mapURIParams = this._mapURIParams(currentMethod.parameters, currentMethodResolved.parameters);
			var pathParams = {};
