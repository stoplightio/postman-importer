...
RAML.prototype._mapQueryParameters = function(queryParameters) {
...
RAML.prototype._mapQueryString = function(queryString) {
...
RAML.prototype._convertRequiredToArray = function(object, key, required) {
...
RAML.prototype.loadFile = function (filePath, options) {
	var me = this;
	if (options && options.hasOwnProperty('validateOutput') && options.validateOutput === true) {
