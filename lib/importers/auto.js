...
class Auto extends Importer {
	...
	getDetectedFormat = function () {
		return this.detectedFormat;
	};
	
	_parseStopLightX = function (data, resolve, reject) {
		let self = this,
	...
	_parsePostman = function (data, resolve, reject) {
		let self = this,
			postman = new Postman();
	...
	_parseRAML = function (data, resolve, reject, options) {
		let self = this;
		let raml;
		let detectedFormat;
	...
	_parseSwagger = function (data, resolve, reject, options) {
		let self = this,
			swagger = new Swagger();
