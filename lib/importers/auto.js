const fs = require('fs'),
	...
	RAML08Importer = require('./raml08'),
	RAML10Importer = require('./raml10'),
...
class Auto extends Importer {
	...
	_parseStopLightX(data, resolve, reject, options) {
		let self = this,
			stopLightX = new StopLightX();
		
		stopLightX.loadData(data, options)
			.then(() => {
