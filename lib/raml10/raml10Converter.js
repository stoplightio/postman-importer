...
class Raml10Converter extends Converter {
	...
	export(model) {
        ...
        if (model.annotationTypes) ramlDef.annotationTypes = annotationTypeConverter.export(model.annotationTypes);
				...
				const definitionConverter = new Raml10DefinitionConverter(ramlDef);
				...
				const traitConverter = new Raml10TraitConverter(ramlDef);
				...
				const resourceConverter = new Raml10ResourceConverter(model, ramlDef);
