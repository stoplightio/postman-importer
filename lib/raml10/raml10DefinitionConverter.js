...
class Raml10DefinitionConverter extends Converter {
	...
	_import(ramlDef) {
		...
		const attrIdCopyRaml10= _.concat(attrIdCopyRaml, ['name', 'uniqueItems', 'discriminator', 'multipleOf', 'pattern', 'displayName', 'default', 'schemaPath', 'required', 'xml', 'additionalProperties', 'minItems', 'maxItems', 'annotations', 'allowedTargets', '$ref']);
