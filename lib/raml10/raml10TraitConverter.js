...
class Raml10TraitConverter extends Converter {
	...
	export(models) {
		...
		const result = {};
		Raml10TraitConverter.exportResponses(models);
	...
	_export(model) {
		...
		const methodConverter = new Raml10MethodConverter(null, this.rootRamlDef);
