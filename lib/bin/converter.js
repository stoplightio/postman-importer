...
var from = formats.AUTO;
var to = formats.RAML;
var validate = false;
var file = undefined;

program.arguments('<file>').option('-f, --from <from>', 'the from/input spec, valid values are: swagger, raml08, raml10 and auto (default)').option('-t, --to <to>', 'the to/target spec, valid values are: swagger, raml08 and raml10 (default)').option('-v, --validate <validate>', 'true to validate the output (defaults to false)').action(function (f) {
	file = f;
