...
class Oas20DocumentRootConverter extends Converter{
	...
	_export(model) {
		...
		const attrIdSkip = ['info', 'baseUri', 'mediaType', 'documentation', 'baseUriParameters'];
...
module.exports = Oas20DocumentRootConverter;