	...
	_export(model) {
		...
		if (this.model && this.model.hasOwnProperty('mediaType')) {
			...
			if (mediaType.hasOwnProperty('consumes') && oasDef.hasOwnProperty('consumes'))
				if (_.isEqual(mediaType.consumes.sort(), oasDef.consumes.sort())) delete oasDef.consumes;
			if (mediaType.hasOwnProperty('produces') && oasDef.hasOwnProperty('produces'))
				if (_.isEqual(mediaType.produces.sort(), oasDef.produces.sort())) delete oasDef.produces;
		}
		return oasDef;
	}
