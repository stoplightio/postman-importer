...
class Oas20TraitConverter extends Converter {
	...
	import(oasDefs) {
		...
		for (const id in oasDefs.responses) {
			...
			responses[id] = Oas20MethodConverter.importResponse(oasDefs.responses[id], new Oas20DefinitionConverter(this.model));
		}
		if (!_.isEmpty(responses)) {
			oasDefs['x-oas-responses'] = responses;
			Oas20RootConverter.importAnnotations(oasDefs, this.model, this.model);
		}
