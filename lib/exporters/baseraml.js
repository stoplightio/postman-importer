...
class RAML extends Exporter {
	...
	_addFacetsDeclaration(property, target) {
	...
	_mapEndpointTraits(slTraits, endpoint) {
		let is = [];
	...
	getDefaultMimeType(mimeType, defMimeType) {
	...
	_addExtensions(ramlDef, ramlObject, extensions) {
	...
	checkRequiredProperty(object, paramName) {
