...
class RAML extends Exporter {
	...
	static withoutFormatParameter(obj) {
        if (obj.hasOwnProperty('format') && obj.type === 'string') delete obj.format;
        return obj;
	}
	...
	_annotationsSignature(ramlDef) {
		if (this.hasTags || this.hasDeprecated || this.hasExternalDocs || this.hasInfo ||
			this.hasSummary || this.hasSchemaTitle || this.hasBodyName || this.hasResponsesDefault || this.hasGlobalResponseDefinition) {
