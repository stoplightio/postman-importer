...
class Swagger extends Exporter {
	...
	_mapEndpointSecurity(securedByTypes, securityDefinitions) {
		let security = [];
	...
	_mapSecurityDefinitions(securityDefinitions) {
		let result = {};
	...
	_addPatternedObjects(source, target) {
	...
	_convertToTemplateUri(swaggerDef) {
